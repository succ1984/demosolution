    ...
    function PrepareSortablePlaces(sortableItems, settings) {
        ...
        $(s.selectors.places).sortable({
            ...
            start: function(e, ui) {
                ...
                // $(document.body).width(Number($BodyWidth) + Number($(ui.helper).attr("inswidth")));
                //$(document.body).width(Number($BodyHeight) + Number($(ui.helper).height()));
                return true;
            },
            stop: function(e, ui) {
