<%@ Page Title="" Language="C#" MasterPageFile="~/layout/main.master" AutoEventWireup="true" CodeFile="welcome.aspx.cs" Inherits="App_drag_drop_welcome" %>



<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div class="dragBox">
    <div class="dragDiv" id="drag1"></div>
    <div class="dragDiv" id="drag2"></div>
</div>
...
<style type="text/css">   
    ...
    .dragDiv{position:absolute;width:100px;height:100px;cursor:move;border:1px solid #888;background:#000;}
